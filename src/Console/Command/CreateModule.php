...
class CreateModule extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if($this->config->getFullModuleList()->has($module->getMagentoModuleName())) {
            throw new InvalidArgumentException('The module '. $module->getMagentoModuleName() .' already exists. Please use another module name.');
        }
    ...
    public function writeModuleToComposer(Composer $composer, ModuleInfo $module)
    {
        ...
        $composer->put("require", ["magento/framework" => "*"]);
     ...
     */
    public function getComposer($path): Composer
    {
    ...
    protected function printSuccess(OutputInterface $output, ModuleInfo $module)
    {
        ...
        $output->writeln('Run <fg=white;bg=cyan>composer update '.$module->getPackageName().'</> if your own created classes do not get autoloaded.');
